...
This project involves creating a comprehensive Sales Analytics Dashboard using Microsoft Power BI. The dashboard provides key insights into sales performance, leveraging various Power BI features such as data modeling, DAX calculations, and interactive visualizations. This project was developed by following a detailed YouTube tutorial, which guided through each step of the process, from data modeling to dashboard design.
...
- **Data:** Contains the raw data files used for this project.
- **PowerBI Dashboard (.pbix):** The Power BI file containing the developed dashboard and all associated reports.
- **Screenshots:** Contains screenshots of the final dashboard and key visualizations.
- **README.md:** This file provides an overview of the project and instructions for use.

## 🛠️ **Features and Learning Outcomes**
